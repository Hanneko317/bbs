...
namespace bbs.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString)
        {
            ...
            var viewModel = new PostModelView
            {
                SortOrder = sortOrder,
            ...
            {
                postQuery = postQuery.Where(p => p.Content.Contains(searchString) || p.UserName.Contains(searchString));
            }
            switch (sortOrder)
            {
                case "content_asc":
            ...
            viewModel.Posts = await postQuery.AsNoTracking().ToListAsync();
